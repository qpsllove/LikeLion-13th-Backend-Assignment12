...
public enum SuccessStatus {
    ...
    ANIMAL_CREATED(HttpStatus.CREATED, "ANIMAL201", "반려동물이 성공적으로 생성되었습니다."),
    ANIMAL_SUCCESS(HttpStatus.OK, "ANIMAL200", "반려동물을 성공적으로 조회했습니다."),
    ANIMAL_UPDATED(HttpStatus.OK, "ANIMAL200", "반려동물이 성공적으로 수정되었습니다."),
    ANIMAL_DELETE(HttpStatus.OK, "ANIMAL200", "반려동물이 성공적으로 삭제되었습니다.");
